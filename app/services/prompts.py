...
SUMMARY_ENGINE = (
    ...
    "1. MEHRFACHANFRAGEN: Wenn der Nutzer zwei oder mehr Dinge gleichzeitig anfragt,\n"
    "   ist eine Zusammenfassung in 90%% der Fälle zwingend erforderlich, um die Übersicht\n"
    "   zu wahren.\n"
    "2. KOMPLEXITÄT: Bei komplizierten oder längeren Texten ist eine Bestätigung wichtig.\n"
    "3. SENSITIVITÄT: Sei 'sensibler' beim Erstellen von Zusammenfassungen. Die Schwelle,\n"
    "   eine Zusammenfassung wegzulassen, soll klein sein. Auch bei einfacheren Anfragen\n"
    "   solltest du oft eine kurze Bestätigung geben.\n"
    "4. KÜRZE: Wenn die Aufgabe klar ist, genügt ein einziger, prägnanter Satz als\n"
    "   Zusammenfassung.\n"
    "\n"
    ...
    "- Lege besonderen Fokus auf Elemente, die missverständlich sein könnten.\n"
    "- Bei mehreren Teilaufgaben nutze übersichtliche Aufzählungspunkte.\n"
    "- Liefere keine inhaltliche Ausarbeitung, keine Beispiele und keine Details der\n"
    "  eigentlichen Antwort.\n"
    "- Wenn die Anfrage EXTREM simpel oder trivial ist (z.B. nur 'Hallo' oder 'Danke'),\n"
    "  gib exakt das Wort 'SKIP' aus. Ansonsten erstelle eine Zusammenfassung.\n"
    "- Beginne deine Ausgabe NIEMALS mit einem Präfix wie 'Summary Engine:',\n"
    "  'Zusammenfassung:' oder ähnlichem."
)
